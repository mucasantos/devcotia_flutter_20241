import 'package:devnoite_quiz/bmi/controller/imc_calculator.dart';
...
class _HomeScreenBmiState extends State<HomeScreenBmi> {
  ...
  int peso = 56;
  String text =
      " Text.app is a simple text editor for Chrome OS and Chrome. It's fast, lets you open multiple files at once, has syntax highlighting,";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.small(
        ...
        onPressed: () {
          IMCCalculator resultado = IMCCalculator(altura: altura, peso: peso);
          
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => ResultPage(
                imc: resultado.calculaIMC(),
                textInterpreta: resultado.getTextResultado(),
                textResultado: resultado.getResultado(),
              ),
            ),
          );
        },
